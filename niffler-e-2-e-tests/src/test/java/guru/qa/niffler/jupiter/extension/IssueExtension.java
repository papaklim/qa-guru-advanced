...
public class IssueExtension implements ExecutionCondition {
	...
	public ConditionEvaluationResult evaluateExecutionCondition(ExtensionContext context) {
		...
		return annotation.map(
			byIssue -> "open".equals(ghApiClient.issueState(byIssue.value())) ? ConditionEvaluationResult.disabled(
				"Disabled by Issue: ".concat(byIssue.value())) : ConditionEvaluationResult.enabled(
					"Issue closed")).orElseGet(
