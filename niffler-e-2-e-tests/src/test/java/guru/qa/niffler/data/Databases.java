...
public class Databases {
    ...
    public record XaConsumer(Consumer<Connection> consumer, String jdbcUrl, int isolationLevel) {
        public XaConsumer(Consumer<Connection> consumer, String jdbcUrl) {
            this(consumer, jdbcUrl, Connection.TRANSACTION_READ_COMMITTED);
        }
    }
    ...
    public static <T> T xaTransaction(XaFunction<T>... actions) {
        UserTransaction ut = new UserTransactionImp(); // Распределенная транзакция
        try {
            ut.begin();
            T result = null;
